...
var modals = function modals() {
  ...
  function modal(trigger, mod, modClose) {
    ...
    function openModal() {
      document.body.style.paddingRight = "".concat(calcScroll() + 1, "px");

      if (document.querySelector('.fixed-gift')) {
        document.querySelector('.fixed-gift').style.marginRight = "".concat(calcScroll() + 0.5, "px");
      }
      ...
      if (destroy) {
        triggerBtn.forEach(function (item) {
          return item.remove();
        });
      }
    }
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      ...
      if (!display) {
        ...
        document.body.classList.add('modal-open');
        document.body.style.paddingRight = "".concat(calcScroll(), "px");
      }
    }, time);
  }
  ...
  modal('.fixed-gift', '.popup-gift', '.popup-close', true, true); // showModalByTime('.popup-consultation', 5000) 
};
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  function activateAnimation(params) {
    if (dir === 'vertical') {
